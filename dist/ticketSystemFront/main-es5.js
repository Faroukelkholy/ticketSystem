(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [{ path: '', redirectTo: 'app/login', pathMatch: 'full' },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(router, userService, cdr, _bottomSheet) {
                    this.router = router;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BottomSheetComponent = /** @class */ (function () {
                function BottomSheetComponent(_bottomSheetRef) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateTicketComponent = /** @class */ (function () {
                function CreateTicketComponent(router, formBuilder, ticketService, userService) {
                    this.router = router;
                ...
                CreateTicketComponent.prototype.submitTicket = function () {
                    var _this = this;
                    console.log(this.ticketForm.value);
                    this.ticketService.saveTicket(this.ticketForm.value, this.user, this.access_token).subscribe(function (data) {
            ...
            CreateTicketComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateUserComponent = /** @class */ (function () {
                function CreateUserComponent(router, formBuilder, userService) {
                    this.router = router;
                    this.formBuilder = formBuilder;
                    this.userService = userService;
                }
                ...
                CreateUserComponent.prototype.submitUser = function () {
                    ...
                    this.userService.saveUser(this.userform.value).subscribe(function (data) {
                        console.log('!submituser saveUser:', data);
                        if (data.message === 'Success') {
                            _this.router.navigate(['/app/users']);
                        }
                    }, function (error) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ErrorComponent = /** @class */ (function () {
                function ErrorComponent(dialogRef, data, router) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(dialog, router, userService, ticketService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.userService = userService;
                    this.ticketService = ticketService;
                ...
                HomeComponent.prototype.ngOnInit = function () {
                    ...
                    if (!_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"].access_token) {
                        ...
                        console.log('this.user :', this.user);
                        this.access_token = this.userService.queryAccess_token();
                        this.ticketService.getTickets(this.access_token).subscribe(function (data) {
                            _this.tickets = data.result;
                            console.log('!this.tickets this.tickets data.result :', _this.tickets);
                        }, function (error) {
                            console.log('getNews error :', error);
                            _this.dialog.open(_error_error_component__WEBPACK_IMPORTED_MODULE_5__["ErrorComponent"], {
                                data: {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(dialog, router, formBuilder, userService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.formBuilder = formBuilder;
                    this.userService = userService;
                ...
                LoginComponent.prototype.submitLogin = function () {
                    var _this = this;
                    this.userService.login(this.myLoginForm.value).subscribe(function (data) {
                        if (data.message === 'Success') {
                            ...
                            _this.dialog.open(_error_error_component__WEBPACK_IMPORTED_MODULE_6__["ErrorComponent"], { data: {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OperatorComponent = /** @class */ (function () {
                function OperatorComponent(socketService) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SocketService = /** @class */ (function () {
                function SocketService() {
                    ...
                    this.getMessages = function (topic) {
                        return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
                            _this.socket.on(topic, function (message) {
                ...
                SocketService.prototype.sendMessage = function (topic, message) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StatisticsService = /** @class */ (function () {
                ...
                StatisticsService.prototype.getTicketStatisctis = function (access_token) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', "Bearer " + access_token);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TicketService = /** @class */ (function () {
                ...
                TicketService.prototype.getTickets = function (access_token) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', "Bearer " + access_token);
                ...
                TicketService.prototype.saveTicket = function (ticket, user, access_token) {
                    var body = {
                        ticket: ticket,
                        author: user
                    };
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', "Bearer " + access_token).set('Content-type', 'application/json');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _handleError__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./handleError */ "./src/app/services/handleError.ts");
            var UserService_1;
            var UserService = UserService_1 = /** @class */ (function () {
                function UserService(http) {
                    this.http = http;
                }
                UserService.prototype.queryAccess_token = function () {
                    UserService_1.access_token = localStorage.getItem('access_token');
                    return UserService_1.access_token;
                };
                UserService.prototype.queryUser = function () {
                    UserService_1.user = localStorage.getItem('user');
                    return UserService_1.user;
                };
                UserService.prototype.getUsers = function () {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', "Bearer " + UserService_1.access_token);
                ...
                UserService.prototype.saveUser = function (user) {
                    ...
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', "Bearer " + UserService_1.access_token).set('Content-type', 'application/json');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StatisticsComponent = /** @class */ (function () {
                function StatisticsComponent(dialog, userService, statisticsService) {
                    this.dialog = dialog;
                    this.userService = userService;
                ...
                StatisticsComponent.prototype.ngOnInit = function () {
                    ...
                    if (!_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"].access_token) {
                        ...
                        console.log('this.user :', this.user);
                        this.access_token = this.userService.queryAccess_token();
                        this.statisticsService.getTicketStatisctis(this.access_token).subscribe(function (data) {
                            _this.stats = JSON.stringify(data.result);
                            console.log('!this.tickets this.tickets data.result :', _this.stats);
                        }, function (error) {
                            console.log('getNews error :', error);
                            _this.dialog.open(_error_error_component__WEBPACK_IMPORTED_MODULE_5__["ErrorComponent"], {
                                data: {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserComponent = /** @class */ (function () {
                function UserComponent(dialog, router, userService) {
                    this.dialog = dialog;
                    this.router = router;
                    this.userService = userService;
                ...
                UserComponent.prototype.ngOnInit = function () {
                    ...
                    this.userService.getUsers().subscribe(function (data) {
                        ...
                        console.log('!this.users this.users data.result :', _this.users);
                    }, function (error) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BackendURL = /** @class */ (function () {
                ...
                BackendURL.handleError = function (error) {
                    var errMsg;
